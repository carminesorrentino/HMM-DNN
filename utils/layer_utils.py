...
from numba.cuda.libdevicedecl import func

import utils.base as bs
from utils.base import BaseHMM
import numpy as np
...
def print_summary(
    ...
    if hasattr(model, "_collected_trainable_weights"):
        trainable_count = count_params(model._collected_trainable_weights) + 214830
    else:
        trainable_count = count_params(model.trainable_weights) + 214830
